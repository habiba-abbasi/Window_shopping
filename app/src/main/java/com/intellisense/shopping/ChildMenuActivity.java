...
import com.intellisense.shopping.databinding.ActivityChildMenuBinding;
...
public class ChildMenuActivity extends Base {

    ActivityChildMenuBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       binding= DataBindingUtil.setContentView(this,R.layout.activity_child_menu);
    ...
    public class JSONTask extends AsyncTask<String, String, String> {
       ...
       // ProgressBar dialog;
        ...
        protected void onPostExecute(String result) {
            ...
            calligrapher = new Calligrapher(ChildMenuActivity.this);
            answer = result.split("\\.");
            for(int i=0;i<answer.length;i++){
                final int var = i;
                button[i] = new Button(ChildMenuActivity.this);
                button[i].setText(answer[i]);
                calligrapher.setFont(ChildMenuActivity.this,"Roboto-Thin.ttf",true);
